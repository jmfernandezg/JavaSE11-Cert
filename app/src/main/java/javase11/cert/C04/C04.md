...
- La sentencia switch permite evaluar una expresion y ejecutar un bloque de codigo dependiendo del valor de la expresion
...
for (Objeto c: misNúmerosFavoritos) System.out.print(c + ", ");
```

1. [ ] A. Se compila y ejecuta sin problemas, pero no produce ningún resultado.
1. [ ] B. 10, 14,
1. [ ] C. 10, 10, 14,
1. [ ] 1. [ ] D. 10, 10, 14, 10, 14,
1. [ ] E. Exactamente una línea de código no se compila.
...
1. [ ] C. La expresión condicional de un bucle for se evalúa antes de la primera ejecución del
cuerpo del bucle.
1. [ ] D. Una declaración de cambio sin una declaración de caso coincidente requiere una declaración predeterminada.
1. [ ] E. Se garantiza que el cuerpo de un bucle do/ while se ejecutará al menos una vez.
...
for() { System.out.println(clima[i]);
} }

```

1. [ ] A. int i=tiempo.longitud; i>0; i--
1. [ ] B.int i=0; i<=tiempo.longitud-1; ++yo
1. [ ] C. var w: clima
1. [ ] D. int i=tiempo.longitud-1; i>=0; i--
1. [ ] E. int i=0, int j=3; i<tiempo.longitud; ++yo
1. [ ] F.int i=0; ++i<10 && i<tiempo.longitud;
...
1. [ ] A. break CONEJITO
1. [ ] B. break CONEJO
1. [ ] C. continuar CONEJITO
1. [ ] D. continuar CONEJO
1. [ ] E. break
1. [ ] F. continuar
...
private Dia getDia(int día, final int jueves) {
    ...
    switch(otroDía) {
        default:
            ...
            case Dia.LUNES: return Dia.LUNES; }
            return Día.VIERNES;
 }
```
...
int cantar = 8, graznido = 2, notas = 0
...
1. [ ] G. El código no se compila por un motivo diferente.
...
1. [ ] A. El tipo de datos de pingüino es entero.
1. [ ] B. El tipo de datos de pingüino es int.
1. [ ] C. El tipo de datos de emu no está definido.
1. [ ] D. El tipo de datos de emu es Carácter.
1. [ ] E. El tipo de datos de guacamayo no está definido.
1. [ ] F. El tipo de datos de guacamayo es Objeto.
...
no coincide con el tipo de datos de la variable de cambio.
1. [ ] F. Ninguna de las anteriores

### 12. Dada la siguiente matriz, ¿qué fragmentos de código imprimen los elementos en orden inverso al de cómo?

están declarados? (Elija todas las que correspondan).
...
```java
final int r = lobo.longitud;
for(int w = r-1; r>-1; w = r-1) System.out.print(wolf[w]);
```
...
### 15. ¿Qué declaraciones, cuando se insertan en los siguientes espacios en blanco, permiten que el código se compile y

¿Correr sin entrar en un bucle infinito? (Elija todas las que correspondan).
...
1. [ ] A. break L2 en la línea 8; continúa L2 en la línea 12
1. [ ] B. continúe en la línea 8; continúa en la línea 12
1. [ ] C. rompa L3 en la línea 8; break L1 en la línea 12
1. [ ] D. continúe L2 en la línea 8; continúa L3 en la línea 12
1. [ ] E. continúe L2 en la línea 8; continúa L2 en la línea 12
...
1. [ ] D. 3 5 1
1. [ ] E. 5 2 1
1. [ ] F. El código no se compilará debido a las líneas 3 a 5.
...
```java
 ...
 if (mayor = verdadero) System.out.println("Éxito");
...
1. [ ] B. Fracaso
1. [ ] C. Otros
1. [ ] D. El código no se compilará debido a la línea 17.
...
1. [ ] F. El código se compila pero nunca finaliza en tiempo de ejecución.
